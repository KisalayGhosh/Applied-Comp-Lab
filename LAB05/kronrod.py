...
#  Input:
#
#    integer N, the order of the Gauss rule.
#
#    integer M, the value of ( N + 1 ) / 2.
#
#    real TOL, the requested absolute accuracy of the abscissas.
#
#    real COEF2, a value needed to compute weights.
#
#    logical EVEN, is TRUE if N is even.
#
#    real B(M+1), the Chebyshev coefficients.
#
#    real X, an estimate for the abscissa.
#
#  Output:
#
#    real X, the abscissa.
...
#    integer M, the value of ( N + 1 ) / 2.
#
#    real TOL, the requested absolute accuracy of the
#    abscissas.
#
#    real COEF2, a value needed to compute weights.
#
...
#    real X, the abscissa.
#
#    real W1, the Gauss-Kronrod weight.
#
#    real W2, the Gauss weight.
#
  if ( x == 0.0 ):
    ka = 1
  else:
...
#
#    real W1(N+1), the weights for the Gauss-Kronrod rule.
#
#    real W2(N+1), the weights for the Gauss rule.
#
  import numpy as np
...
#
#    real X(N+1), W1(N+1), W2(N+1), the abscissas and weights.
#
#  Output:
#
#    real X(N+1), W1(N+1), W2(N+1), the adjusted abscissas and weights.
#
...
#*****************************************************************************80
#
## kronrod_test03() uses kronrod() to estimate an integral.
#
#  Licensing:
#
#    This code is distributed under the MIT license. 
